...
RUN apk add --update bash git build-base coreutils file linux-headers wget tar curl perl openssl zlib zlib-dev lz4 lz4-dev bzip2 bzip2-dev snappy snappy-dev openjdk7
RUN cd /tmp && \
